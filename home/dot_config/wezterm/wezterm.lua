...
local themes = {
    ...
    light = { -- Gruvbox Light (warm sepia, harmonized)
        bg            = "#d5c4a1",
        foreground    = "#3c3836",
        cursor_bg     = "#af3a03",
        cursor_fg     = "#d5c4a1",
        cursor_border = "#af3a03",
        selection_fg  = "#3c3836",
        selection_bg  = "#bdae93",
        ansi = {
            "#7c6f64", "#9d0006", "#3f7a4f", "#b57614",
            "#076678", "#8f3f71", "#427b58", "#3c3836",
        },
        brights = {
            "#928374", "#cc241d", "#52a064", "#d79921",
            "#458588", "#b16286", "#689d6a", "#282828",
        },
        bg_opacity    = 0.97,
        gradient      = { "#2820001c", "#00000000", "#2820001c" },
        tab_bar_bg    = "#bdae93",
        new_tab_fg    = "#7c6f64",
        new_tab_hover = { bg = "#a89984", fg = "#3c3836" },
        tab_act       = { bg = "#a89984", fg = "#282828" },
        tab_norm      = { bg = "#bdae93", fg = "#7c6f64" },
        hint_fg       = "#a89984",
    },
}
