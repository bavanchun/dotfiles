...
local themes = {
    ...
    light = { -- Catppuccin Latte (dimmed, low-glare)
        bg            = "#dce0e8",
        foreground    = "#4c4f69",
        cursor_bg     = "#dc8a78",
        cursor_fg     = "#dce0e8",
        ...
        bg_opacity    = 0.95,
        gradient      = { "#00000018", "#00000000", "#00000018" },
        tab_bar_bg    = "#ccd0da",
        new_tab_fg    = "#9ca0b0",
        new_tab_hover = { bg = "#bcc0cc", fg = "#5c5f77" },
        tab_act       = { bg = "#bcc0cc", fg = "#4c4f69" },
        tab_norm      = { bg = "#ccd0da", fg = "#9ca0b0" },
        hint_fg       = "#acb0be",
    },
}
